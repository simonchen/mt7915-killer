...
## Perfermance
- The base of average DL rate after continously running ```iperf3 -R -w 1M -P1``` for 17 hours
...
## Stress Test Summary
- Tested on MT7621 @880MHz with Killer-1535 NIC (PC runs on ```iperf3 -R -w 1M -P 1```)
